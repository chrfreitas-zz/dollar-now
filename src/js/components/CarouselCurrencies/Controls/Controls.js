...
const ButtonsIcons = ButtonStyled.extend`
    border: none;
    padding: 5px 0;
`;
...
class Controls extends Component {
    static propTypes = {
        ...
        buttonUpDisabled: PropTypes.bool,
        buttonDownDisabled: PropTypes.bool
    }

    onUpClick = () => {
        this.props.handleChangeCurrency(-1)
    }
    ...
    render() {
        return (
            <Constrols>
                <ButtonsIcons onClick={this.onUpClick} disabled={this.props.buttonUpDisabled}>
                ...
                <ButtonsIcons onClick={this.onDownClick} disabled={this.props.buttonDownDisabled}>
